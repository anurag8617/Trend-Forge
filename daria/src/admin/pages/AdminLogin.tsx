...
export default function AdminLogin() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // FIX: Save specifically as 'adminToken' and 'adminUser'
        ...
        <div className="w-full max-w-[360px]">
          <div className="flex items-center gap-4 mb-10">
            ...
            <div>
              ...
              <p className="text-[13px] text-[#8A8F98]">Secure access to the control panel</p>
            </div>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <button
              type="submit"
              className="w-full bg-[#26E7FF] hover:bg-[#5AD7E5] text-black font-semibold py-3 rounded-md transition-colors text-sm mt-4"
            >
              Sign in
            </button>
          </form>
